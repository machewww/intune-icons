...
Applications are displayed in the Intune Company Portal app or at https://portal.manage.microsoft.com/ for end-user self-service install. Using high quality product icons ensures users see a familiar interface when accessing these applications.
...
WHile the repository itself is license with an MIT license, the icons themselves remain the property of their respective software vendors.
